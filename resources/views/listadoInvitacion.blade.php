                        ...
                        <tbody>
                            @foreach ($datos as $d)
                                <tr>
                                    ...
                                    <td>{{ $d->invitados }}</td>
                                    <td>
                                        <button onclick="modificarRegistro({{ $d->id }}, '{{ $d->nombre }}', '{{ $d->telefono }}', {{ $d->invitados }})" class="button is-secondary is-small" data-tooltip="Editar">
                                            <i class="fas fa-edit"></i>
                                        </button>
                                        <button onclick="enviarinvitacion('{{ $d->nombre }}', '{{ $d->telefono }}', '{{ $d->codigo }}')" class="button is-info is-small" data-tooltip="Enviar invitacion por WA">
                                            <i class="fas fa-envelope"></i>
                                        </button>
                                        {{-- <button class="button is-success is-small" data-tooltip="Descargar invitacion">
                                            <i class="fas fa-file"></i>
                                        </button> --}}
                                        <button onclick="eliminar({{ $d->id }})" class="button is-danger is-small" data-tooltip="Eliminar">
